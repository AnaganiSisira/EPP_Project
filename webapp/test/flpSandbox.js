		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "EPP_Request_Type",
									"targetURL": "#eppresquesttypes-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"eppresquesttypes-display": {
								"semanticObject": "eppresquesttypes",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=eppresquesttypes",
									"url": sap.ui.require.toUrl("eppresquesttypes")
								}
							}
						}
					}
